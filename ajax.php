...
if (!empty($_FILES['file'])) {
    ...
    // Если не файл, значит это идут команды управления
    // --------------------------------------------------------
    ...
    // --------------------------------------------------------
    // Редактор существующего пользователя
    // --------------------------------------------------------        
    ...
    // --------------------------------------------------------        
    // row_reload - вернуть данные существующего получателя 
    // --------------------------------------------------------        
    ...
    // --------------------------------------------------------
    // userlist_add - удалить данные получателя 
    // --------------------------------------------------------        
